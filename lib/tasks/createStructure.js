...
var read = util_1.promisify(fs_1.default.readdir);
/**
...
function copyFiles(options, type) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, copy(checkCopyType(options, type), options.targetDirectory, {
                        clobber: false,
                    })];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, read(options.targetDirectory)];
                case 1:
                    _a.sent();
                    return [2 /*return*/, mkdir(options.targetDirectory)];
            }
        });
    });
}
