    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    readmeFile = _a.sent();
                    return [4 /*yield*/, generateMarkdown_1.generateTESTING()];
                case 2:
                    testFile = _a.sent();
...
function createProcfile(options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    content = options.template.flask ? "web: python app.py" : "web: gunicorn " + options.name.replace(/[^A-Z0-9]+/gi, '-').toLowerCase() + ".wsgi:application";
